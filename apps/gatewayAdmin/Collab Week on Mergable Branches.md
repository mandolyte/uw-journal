...
From discord:
@Cecil Ok, all my work is in to develop. I've tested with https://qa.door43.org/dcs-poc-org/en_tn and reset it just now. To reset, just delete it (make sure you're doing this on qa!), then go to + => New Migration => Gitea and just put https://git.door43.org/dcs-poc-org/en_tn as the URL, and change Owner to dcs-poc-org (you're a member) and the repo name should be populated already (en_tn). 
Updated the github.io pages @ https://unfoldingword.github.io/dcs-branch-merger 

![[Pasted image 20230324070323.png]]
...
curl -X 'POST' \
  ...
  -d '{
  "Do": "merge",
  "MergeCommitID": "ca70863d71995750fdacc1afdb81948888fe9014",
  "MergeMessageField": "this is merge message field",
  "MergeTitleField": "this merge title field",
  "delete_branch_after_merge": true,
  "force_merge": true,
  "head_commit_id": "ca70863d71995750fdacc1afdb81948888fe9014",
...
# Appendix C - PR when no changes 
https://git.door43.org/api/v1/repos/unfoldingWord/en_ult/pulls/3357

```json
{
  "id": 11029,
  "url": "https://qa.door43.org/unfoldingWord/en_ult/pulls/3357",
  "number": 3357,
  "user": {
    "id": 13993,
    "login": "cecil.new",
  ...
  "is_locked": false,
  "comments": 0,
  "html_url": "https://qa.door43.org/unfoldingWord/en_ult/pulls/3357",
  "diff_url": "https://qa.door43.org/unfoldingWord/en_ult/pulls/3357.diff",
  "patch_url": "https://qa.door43.org/unfoldingWord/en_ult/pulls/3357.patch",
  "mergeable": true,
  "merged": false,
  "merged_at": null,
  "merge_commit_sha": null,
  ...
  "base": {
    "label": "master",
    "ref": "master",
    "sha": "ca70863d71995750fdacc1afdb81948888fe9014",
    "repo_id": 11419,
    "repo": {
      "id": 11419,
      "owner": {
      ...
      "archived": false,
      "created_at": "2017-06-01T22:16:16Z",
      "updated_at": "2023-03-20T20:26:38Z",
      "permissions": {
        "admin": true,
        "push": true,
        "pull": true
  ...
  "merge_base": "ca70863d71995750fdacc1afdb81948888fe9014",
  "due_date": "2023-03-20T20:27:53Z",
  "created_at": "2023-03-20T20:29:40Z",
  "updated_at": "2023-03-20T20:29:40Z",
  "closed_at": null
}
```

ca70863d71995750fdacc1afdb81948888fe9014
ca70863d71995750fdacc1afdb81948888fe9014